...
export const showHomePage = () => {
  ...
  const play = el("button", { className: "oh-btn primary", textContent: "⚔  Enter Web Historia", onclick: enter });
  play.disabled = true;
  playBtn = play;
  const foot = el("div", { className: "oh-foot" },
    el("a", { href: "https://github.com/ikkihomes420-jpg/web-historia", target: "_blank", rel: "noopener", textContent: "GitHub" }),
  ...
  const card = el("div", { className: "oh-card" },
    ...
    el("h1", { className: "oh-logo" }, "Web ", el("span", { className: "oh-grad", textContent: "Historia" })),
